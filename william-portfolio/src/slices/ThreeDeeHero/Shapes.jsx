...
import { ContactShadows, Float, Environment, Tube } from "@react-three/drei"
...
function Geometries() {
    ...
    const materials = [new THREE.MeshNormalMaterial(), 
        ...
        new THREE.MeshStandardMaterial({ color: 0x130f40, roughness: 0.2}),
        new THREE.MeshStandardMaterial({ color: 0xf0932b, roughness: 0.5, metalness: 0.7}),
